...
from verificacion_acreditacion.infrastructure.orm import IdempotencyKeyORM
...
class IdempotencyService:
    ...
    def _serialize_result(result: Any) -> dict:
        if hasattr(result, "id"):
            return {
                "proveedor_id": str(result.id),
                "estado_verificacion": result.estado_verificacion.value,
                "estado_acreditacion": result.estado_acreditacion.value,
            }
